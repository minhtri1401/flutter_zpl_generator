...
class GraphicsDemo extends StatelessWidget {
  ...
  List<ZplCommand> _buildCommands() {
    return [
      ...
      // Rounded box
      ZplBox(x: 200, y: 130, width: 150, height: 100, borderThickness: 2, cornerRounding: 5),
      ZplText(x: 215, y: 165, text: 'Rounded', fontHeight: 16, fontWidth: 14),

      // Filled box
      ZplBox(x: 380, y: 130, width: 150, height: 100, borderThickness: 100),
      ZplText(x: 395, y: 165, text: 'Filled', fontHeight: 16, fontWidth: 14, reversePrint: true),

      // Reverse print box
      ZplBox(x: 560, y: 130, width: 150, height: 100, borderThickness: 100, reversePrint: true),
      ZplText(x: 575, y: 165, text: 'Reverse', fontHeight: 16, fontWidth: 14),

      ZplSeparator(y: 255, thickness: 1),

      // === Circles ===
      ZplText(x: 20, y: 275, text: 'Circles (^GC):', fontHeight: 20, fontWidth: 16),
      ...
      // === Ellipses ===
      ZplText(x: 20, y: 450, text: 'Ellipses (^GE):', fontHeight: 20, fontWidth: 16),

      // Wide ellipse
      ZplGraphicEllipse(x: 20, y: 485, width: 200, height: 80, borderThickness: 2),
      ...
      // Thick ellipse
      ZplGraphicEllipse(x: 380, y: 485, width: 180, height: 90, borderThickness: 8),
      ZplText(x: 430, y: 520, text: 'Thick', fontHeight: 14, fontWidth: 12),

      ZplSeparator(y: 610, thickness: 1),

      // === Diagonal Lines ===
      ZplText(x: 20, y: 630, text: 'Diagonal Lines (^GD):', fontHeight: 20, fontWidth: 16),

      // Right-leaning
      ZplGraphicDiagonalLine(
        x: 20, y: 665,
        width: 150, height: 120,
        borderThickness: 3, orientation: 'R',
      ),
      ...
      ZplGraphicDiagonalLine(
        x: 200, y: 665,
        width: 150, height: 120,
        borderThickness: 3, orientation: 'L',
      ),
      ...
      ZplGraphicDiagonalLine(
        ...
        borderThickness: 2, orientation: 'R',
      ),
      ZplGraphicDiagonalLine(
        x: 420, y: 665,
        width: 120, height: 120,
        borderThickness: 2, orientation: 'L',
      ),
      ...
      // === ZplRaw escape hatch ===
      ZplText(x: 20, y: 845, text: 'ZplRaw (escape hatch):', fontHeight: 20, fontWidth: 16),

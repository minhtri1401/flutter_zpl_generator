...
class ReceiptItem {
  ...
  ReceiptItem({required this.quantity, required this.name, required this.unitPrice});
...
class ReceiptDemo extends StatelessWidget {
  ...
  List<ZplCommand> _buildCommands() {
    final items = [
      ReceiptItem(quantity: 1, name: 'Fuel Plastic Jug (10 gal)', unitPrice: 34.00),
      ReceiptItem(quantity: 1, name: 'Gas Hose (5 feet)', unitPrice: 15.00),
      ReceiptItem(quantity: 100, name: 'Aluminum Screw (4 in)', unitPrice: 0.87),
    ];
            ...
            child: ZplColumn(
              children: [
                ...
                ZplText(
                  ...
                  fontHeight: 18, fontWidth: 16,
                ),
                ZplText(text: 'machinery@big.com', fontHeight: 18, fontWidth: 16),
              ],
            ),
          ),
          ZplGridCol(
      ...
      ZplTable(
        ...
        headers: [
          ZplTableHeader('Item', alignment: ZplAlignment.left,
              fontHeight: 22, fontWidth: 20),
          ZplTableHeader('Qty', alignment: ZplAlignment.center,
              fontHeight: 22, fontWidth: 20),
          ZplTableHeader('Unit', alignment: ZplAlignment.center,
              fontHeight: 22, fontWidth: 20),
          ZplTableHeader('Total', alignment: ZplAlignment.center,
              fontHeight: 22, fontWidth: 20),
        ],
        data: items
            .map((item) => [
